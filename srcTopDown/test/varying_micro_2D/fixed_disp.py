...
import random
#
# Example with 2D varying microstructure and periodic boundary conditions
#
# mesh
# ----
...
mesh = GooseFEM.Mesh.Quad4.Regular(100, 100)
...
for ilam, lam in enumerate(np.linspace(0.0, 1.0, ninc)):
    ...
    # update displacement
    disp[mesh.nodesRightEdge, 0] += (+20.0/ninc)
    disp[mesh.nodesTopEdge, 1] += (-8.0/ninc)
